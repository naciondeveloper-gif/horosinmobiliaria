    ...
    <div className="flex flex-col min-h-screen">
      <section className="bg-slate-900 text-white py-20 text-center relative overflow-hidden">
        <div className="max-w-3xl mx-auto px-6 relative z-10">
          <h1 className="text-4xl md:text-5xl font-black mb-4 tracking-tight">Sobre Nosotros</h1>
      ...
      <main className="max-w-6xl mx-auto py-16 px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center flex-1">
        ...
        <div className="rounded-lg overflow-hidden shadow-md h-80 bg-slate-200">
          <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=800&q=80" alt="Edificio" className="w-full h-full object-cover" />
        </div>
        <div className="shadow-sm border border-slate-100 rounded-lg p-6 bg-white">
          <div className="flex items-center mb-4">
            <FaBullseye className="text-horosblue mr-2 text-2xl" />
        ...
        <div className="shadow-sm border border-slate-100 rounded-lg p-6 bg-white">
          <div className="flex items-center mb-4">
            <FaEye className="text-horosblue mr-2 text-2xl" />
